    ...
    if (auth.isLogged) {
        return (
            <ul className='navbarContainer'>
                ...
                <li className='navbarWrapper'>
                    <Link className='LinkToWrapper' to='/home'>Notas</Link>
                </li>
                <li className='navbarWrapper'>
                    <span className='LinkToWrapperLogout' onClick={logout}>Sair</span>
                </li>
            </ul>
        )
    } else {
        return (
            <ul className='navbarContainer'>
                <li className='navbarWrapper'>
                    <Link className='LinkToWrapper' to='/login'>Entrar</Link>
                </li>
                <li className='navbarWrapper'>
                    <Link className='LinkToWrapper' to='/registration'>Cadastrar</Link>
                </li>
            </ul>
        )
    }
