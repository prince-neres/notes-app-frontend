    ...
    return (
        <div className='notesInputContainer' >
            <div className='noteInputWrapper'>
                <textarea className='fieldInput' value={noteText} placeholder={'Adicionar nota'}
                       onChange={handleNoteChange}/>
                {noteTextError ? <span className='errorSpan'>Nota está vázia.</span> : null}
            </div>
            <button disabled={submit} className='styledButton' onClick={AddNoteApiCall}>Adicionar</button>
        </div>
    )
}
