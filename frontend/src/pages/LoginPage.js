...
export default function LoginPage() {
    ...
    return (
        <div className="formContainer" onKeyPress={onKeyPress}>
            ...
            <button disabled={submit} className="styledButton" onClick={login}>Entrar</button>
            <Link to="/registration" className="haveAccountP">Você não tem uma conta? Cadastrar</Link>
            <Link to="/recovery" className="haveAccountP">Esqueceu sua senha? Clique aqui</Link>
